...
class DashboardWaitingScreen extends StatelessWidget {
  const DashboardWaitingScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _buildWaitingButton(context),
      ),
    );
  }

  /// Section Widget
  Widget _buildTwentyNineRow(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _buildHowLongStack(
          context,
          captionText: "Sound detection",
          distanceText: "80dB",
        ),
        _buildHowLongStack(
          context,
          captionText: "Trip Travelled",
          distanceText: "70km",
        ),
      ],
    );
  ...
  /// Section Widget
  Widget _buildWaitingButton(BuildContext context) {
